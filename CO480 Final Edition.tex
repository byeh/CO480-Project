...
In other words, the $n$-tuple is a pure Nash Equilibrium if and only if each tuple element is a member of the respective player's best response function.

\begin{proof}
$S^*$ is a pure Nash Equilibrium if and only if $u_i(S^*) \geq u_i(S^*_{-i}, s_i')$ $\forall s_i' \in S_i, \forall i$ if and only if $s^*_{-i} \in B_i(S^*_{-i})$.
\end{proof}
...
\bibitem{2} Robinson, B. (2011, March 30). \textit{Pearl Harbor: A Rude Awakening}. Retrieved June 15, 2015, from \url{http://www.bbc.co.uk/history/worldwars/wwtwo/pearl_harbour_01.shtml}
...
\bibitem{4} 1945: US drops atomic bomb on Hiroshima. (1945, August 6). Retrieved June 26, 2015, from \url{http://news.bbc.co.uk/onthisday/hi/dates/stories/august/6/newsid_3602000/3602189.stm}
\bibitem{5} Children of the Atomic Bomb. (n.d.). Retrieved June 28, 2015, from \url{http://www.aasc.ucla.edu/cab/}
\bibitem{6} Trueman, C. (n.d.). League of Nations Failures - History Learning Site. Retrieved June 20, 2015, from \url{http://www.historylearningsite.co.uk/modern-world-history-1918-to-1980/league-of-nations-failures/}
...
\bibitem{10} Marglin, S., \& Schor, J. (1990). The Golden age of capitalism: Reinterpreting the postwar experience. Oxford: Clarendon Press.
\bibitem{11} Marshall Plan, 1948 - 1945?1952 - Milestones - Office of the Historian, Bureau of Public Affairs, United States Department of State. (n.d.). Retrieved June 27, 2015, from \url{https://history.state.gov/milestones/1945-1952/marshall-plan}
...
\bibitem{13} The Warsaw Treaty Organization, 1955 - 1953?1960 - Milestones - Office of the Historian. (n.d.). Retrieved June 23, 2015, from \url{https://history.state.gov/milestones/1953-1960/warsaw-treaty}
\bibitem{14} Kramer, M. (n.d.). Soviet Bloc. Retrieved June 22, 2015, from \url{http://press.princeton.edu/chapters/pons/s6\_9143.pdf}
\bibitem{15} Cuban Missile Crisis. (2010). Retrieved June 25, 2015, from \url{http://www.history.com/topics/cold-war/cuban-missile-crisis}
...
\bibitem{17} Garber, S. (2007, October 10). Sputnik and The Dawn of the Space Age. Retrieved June 27, 2015, from \url{http://history.nasa.gov/sputnik/}
...
\bibitem{19} Korean War. (2009). Retrieved June 13, 2015, from {http://www.history.com/topics/korean-war}
\bibitem{20} Oh, J., \& Latham, A. (n.d.). Senator Joseph McCarthy, McCarthyism, and The Witch Hunt. Retrieved June 27, 2015, from {http://www.coldwar.org/articles/50s/senatorjosephmccarthy.asp}

%civil rights
\bibitem{21} Patterson, J. (2002). \textit{Brown v. Board of Education a civil rights milestone and its troubled legacy}. Oxford: Oxford University Press.
...
\bibitem{25} Press Release. (1994). Retrieved June 28, 2015, from {http://www.nobelprize.org/nobel\_prizes/economic-sciences/laureates/1994/press.html}

%math

\bibitem{26} Nash, J. (1950). \textit{Non-cooperative Games (Doctoral Thesis, Princeton University, New Jersey)}. Retrieved from \url{http://rbsc.princeton.edu/sites/default/files/Non-Cooperative_Games_Nash.pdf}
\bibitem{27} Von Neumann, J., \& Morgenstern, O. (1944). \textit{Theory of games and economics behavior}. Princeton University Press.
\bibitem{28} Koenemann, J. (2014). \textit{CO456 - Introduction to Game Theory Course Notes} [Personal Communication].
\bibitem{29} Shoham, Y., \& Brown, K. (2010). \textit{Multiagent systems: Algorithmic, game-theoretic, and logical foundations}. Cambridge University Press.
\end{thebibliography}
\end{document}
